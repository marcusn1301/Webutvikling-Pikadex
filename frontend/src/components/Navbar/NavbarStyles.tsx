...
interface LogoTextboxI {
    hover: boolean;
}

export const LogoTextbox = styled.div<LogoTextboxI>`
    display: flex;
    justify-content: space-between;
    gap: 10px;
    @media (max-width: 600px) {
    ...
    &:hover {
        ...
        filter: ${(props) => (props.hover ? "invert(20%)" : "")};
    }
`;
...
interface SearchOuterI {
    hover: boolean;
}

//Wrapper for the searchbar and pokeball button
export const SearchOuter = styled.div<SearchOuterI>`
    display: grid;
    width: 65%;
    height: 40px;
    ...
    .searchIcon {
        ...
        &:hover {
            cursor: ${(props) => (props.hover ? "pointer" : "default")};
            background-color: ${(props) => (props.hover ? "rgb(200, 200, 200)" : "#f4f4f4")};
        }
        /* display: flex; */
        /* align-items: center; */
...
interface PokeBallBtnContainerI {
    hover: boolean;
}

export const PokeballBoxSurpriseMe = styled.div<PokeBallBtnContainerI>`
    color: white;
    border-radius: 6px;
    ...
    &:hover {
        cursor: ${(props) => (props.hover ? "pointer" : "default")};
        background-color: ${(props) => (props.hover ? "rgba(255, 255, 255, 0.2)" : "rgba(255, 255, 255, 0.1)")};
        .pokeballBtn {
...
interface NavbarEdgeI {
    hover: boolean;
}

export const NavbarEdge = styled.img<NavbarEdgeI>`
    position: absolute;
    bottom: -22px;
    z-index: 999;
    width: 270px;
    ...
    &:hover {
        cursor: ${(props) => (props.hover ? "pointer" : "default")};
        filter: ${(props) => (props.hover ? "invert(7.5%)" : "")};
    }
