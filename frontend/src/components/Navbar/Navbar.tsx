                ...
                {tags?.map((tag: string, index: number) => {
                  return (
                    <FilterTags
                      tabIndex={0}
                      onKeyDown={(e) =>
                        handleKeyDownTypeRemove(e, tag[0], tags)
                      }
                  ...
                  <DropdownGridRow>
                    ...
                    <SortByBox aria-label={"Sort by"}>
                      <SortTag
                        ...
                        style={{
                          backgroundColor: toggleIndexASC
                            ? "rgb(20, 20, 20)"
                            : "",
                        }}
                      >
                      ...
                      <SortTag
                        ...
                        style={{
                          backgroundColor: toggleIndexDESC
                            ? "rgb(20, 20, 20)"
                            : "",
                        }}
                      >
                      ...
                      <SortTag
                        ...
                        style={{
                          backgroundColor: toggleFavorited
                            ? "rgb(20, 20, 20)"
                            : "",
                        }}
                      >
