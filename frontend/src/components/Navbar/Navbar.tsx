            ...
            <NavbarOuter transition={small ? true : false} height={checkHeight()}>
                ...
                >
                    <LogoContainer>
                        <LogoTextbox
                            ...
                            tabIndex={!isExpandedGlobal ? 0 : -1}
                            onClick={() => (isExpandedGlobal() ? "" : handleReset())}
                    ...
                    {small && !showDropdown ? (
                        ...
                        <GridContainer>
                            {/* Grid row 1 */}
                            <SearchOuter hover={isExpandedGlobal() ? false : true}>
                                <div className="filler"></div>
                                {/* Grid column 1 */}
                                <div className="searchContainer">
                                    <form onSubmit={handleSubmit}>
                                        <input
                                            tabIndex={checkIfTabable}
                                            type="text"
                                            placeholder="Search by name or index"
                                            className="searchbar"
                                            disabled={isExpandedGlobal()}
                                    ...
                                    <HiMagnifyingGlass
                                        ...
                                        onClick={() => (isExpandedGlobal() ? "" : handleSubmit)}
                                    ...
                                    <DropdownGridRow>
                                        ...
                                        <SortByBox aria-label={"Sort by"}>
                                            <SortTag
                                                ...
                                                style={{
                                                    backgroundColor: toggleIndexASC ? "rgb(20, 20, 20)" : "",
                                                }}
                                            >
                                                Lowest No.
                                            </SortTag>
                                            <SortTag
                                                ...
                                                style={{
                                                    backgroundColor: toggleIndexDESC ? "rgb(20, 20, 20)" : "",
                                                }}
                                            >
                                                Highest No.
                                            </SortTag>
                                            <SortTag
                                                ...
                                                style={{
                                                    backgroundColor: toggleASC ? "rgb(20, 20, 20)" : "",
                                                }}
                                            >
                                                A - Z
                                            </SortTag>
                                            <SortTag
                                                ...
                                                style={{
                                                    backgroundColor: toggleDESC ? "rgb(20, 20, 20)" : "",
                                                }}
                                            >
                                                Z - A
                                            </SortTag>
                                            <SortTag
                                                ...
                                                style={{
                                                    backgroundColor: toggleFavorited ? "rgb(20, 20, 20)" : "",
                                                }}
                                            >
                                                Most favorited
                                            </SortTag>
                ...
                <FilterOuter>
                    <NavbarEdge
                        ...
                        src={navbarEdge}
                        onClick={() => (!isExpandedGlobal() ? setShowDropdown(!showDropdown) : "")}
                        hover={isExpandedGlobal() ? false : true}
                    />
                </FilterOuter>
            </NavbarOuter>
